...
namespace InteractHealthProDatabase.Controllers
{
    public class PetController : Controller
    {
        ...
        public PetController(IhpDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pet != null ? 
                          ...
                          Problem("Entity set 'IhpDbContext.Pet'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Cat,Dog,Details")] Pet pet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cat,Dog,Details")] Pet pet)
        {
            if (id != pet.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'IhpDbContext.Pet'  is null.");
            }
            var pet = await _context.Pet.FindAsync(id);
            if (pet != null)
            {
