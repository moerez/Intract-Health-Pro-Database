...
namespace InteractHealthProDatabase.Data.Migrations
{
    ...
    [Migration("20230421123757_Added-BodyTrauma")]
    partial class AddedBodyTrauma
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("DocumentsSequence");
            ...
            modelBuilder.HasSequence("MedicalHistoryPreAccidentSequence");

            modelBuilder.Entity("Aftab_InteractHealthProDatabase.Models.MedicalHistoryPostAccident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MedicalHistoryPostAccident_1");
                });
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.BodyPart", b =>
                {
                    ...
                    b.Property<string>("NeckAndBackNotes")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.BodyTrauma", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HitToTheHead")
                        .HasColumnType("bit");

                    b.Property<bool>("LossOfContentiousness")
                        .HasColumnType("bit");

                    b.Property<bool>("None")
                        .HasColumnType("bit");

                    b.Property<bool>("PainRightAway")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValueSql("NEXT VALUE FOR [DocumentsSequence]");

                    SqlServerPropertyBuilderExtensions.UseSequence(b.Property<int>("Id"), "DocumentsSequence");

                    b.Property<int>("ClientId")
                        .HasColumnType("int");

                    b.Property<string>("DocumentStr")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.EventViewModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.MedicalHistoryAccident", b =>
                {
                    ...
                    b.Property<int?>("MedicalHistoryPostAccidentId")
                        .HasColumnType("int");

                    b.Property<int?>("MedicalHistoryPreAccidentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MedicalHistoryPostAccidentId");

                    b.HasIndex("MedicalHistoryPreAccidentId");

                    b.ToTable("MedicalHistoryAccident");
                });

            modelBuilder.Entity("InteractHealthProDatabase.Models.MedicalHistoryPreAccident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValueSql("NEXT VALUE FOR [MedicalHistoryPreAccidentSequence]");
                    ...
                    b.ToTable("MedicalHistoryPreAccident");
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentDelivery", b =>
                {
                    b.HasBaseType("InteractHealthProDatabase.Models.Documents.Document");

                    b.Property<DateTime?>("DateDeliveredByIhp")
                        .HasColumnType("datetime2");

                    b.Property<int>("DeliveryMethod")
                        .HasColumnType("int");

                    b.Property<string>("DeliveryMethodNote")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("GeneralTreatmentPlan")
                        .HasColumnType("bit");

                    b.Property<string>("NameOfAssociate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("Ocf18TpReceived")
                        .HasColumnType("bit");

                    b.Property<bool>("Ocf23MigReceived")
                        .HasColumnType("bit");

                    b.Property<string>("To")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("DocumentDeliveries", (string)null);
                });

            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentForm", b =>
                {
                    b.HasBaseType("InteractHealthProDatabase.Models.Documents.Document");
                    ...
                    b.ToTable("DocumentForms", (string)null);
                });

            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentRecovery", b =>
                {
                    b.HasBaseType("InteractHealthProDatabase.Models.Documents.Document");

                    b.Property<DateTime?>("DateReceivedByIhp")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("DocumentRecoveries", (string)null);
                });

            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentRequest", b =>
                {
                    b.HasBaseType("InteractHealthProDatabase.Models.Documents.Document");
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.MedicalHistoryAccident", b =>
                {
                    ...
                    b.HasOne("Aftab_InteractHealthProDatabase.Models.MedicalHistoryPostAccident", "MedicalHistoryPostAccident")
                        .WithMany()
                        .HasForeignKey("MedicalHistoryPostAccidentId");

                    b.HasOne("InteractHealthProDatabase.Models.MedicalHistoryPreAccident", "MedicalHistoryPreAccident")
                        .WithMany()
                        .HasForeignKey("MedicalHistoryPreAccidentId");

                    b.Navigation("Client");

                    b.Navigation("MedicalHistoryPostAccident");

                    b.Navigation("MedicalHistoryPreAccident");
                });
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentDelivery", b =>
                {
                    b.HasOne("InteractHealthProDatabase.Models.Documents.Document", null)
                        .WithOne()
                        .HasForeignKey("InteractHealthProDatabase.Models.Documents.DocumentDelivery", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentForm", b =>
                {
                    b.HasOne("InteractHealthProDatabase.Models.Documents.Document", null)
                        .WithOne()
                        .HasForeignKey("InteractHealthProDatabase.Models.Documents.DocumentForm", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentRecovery", b =>
                {
                    b.HasOne("InteractHealthProDatabase.Models.Documents.Document", null)
                        .WithOne()
                        .HasForeignKey("InteractHealthProDatabase.Models.Documents.DocumentRecovery", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("InteractHealthProDatabase.Models.Documents.DocumentRequest", b =>
                {
                    b.HasOne("InteractHealthProDatabase.Models.Documents.Document", null)
                        .WithOne()
                        .HasForeignKey("InteractHealthProDatabase.Models.Documents.DocumentRequest", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
